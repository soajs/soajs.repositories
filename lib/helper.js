...
lib = {
	"extractValidation": (commonFields, oneInput, tempInput, inputObj, common) => {
	...
	"getIMFVfromCommonFields": (commonFields, source) => {
	...
	"injectCommonFields": (commonFields, globalParams, all_apis) => {
		let generatedObject = {};
