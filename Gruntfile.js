...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		jshint: {
			...
			files: {
				src: ['index.js', 'config.js', 'Gruntfile.js', 'bl/*.js', 'driver/*.js', 'lib/*.js', 'driver/**/*.js', 'model/mongo/*.js', 'test/helper.js', 'test/unit/**/*.js', 'test/integration/**/*.js']
			},
			gruntfile: {
				src: 'Gruntfile.js'
			}
		...
		instrument: {
			src: ['index.js', 'config.js', 'bl/*.js', 'model/mongo/*.js', 'driver/*.js', 'lib/*.js', 'driver/**/*.js'],
			options: {
				lazy: false,
